...
import org.socraticgrid.fhir.dstu3.generated.Iqicoreencounter;
...
public class qicoreencounterAdapter implements Iqicoreencounter
{
   ...
   public List<qicoreencounterRelatedConditionAdapter> getRelatedCondition() {
		...
		List<org.socraticgrid.fhir.dstu3.generated.qicoreencounterRelatedConditionAdapter> returnList = new java.util.ArrayList<>();
		for (org.hl7.fhir.dstu3.model.Extension extension : extensions) {
			org.socraticgrid.fhir.dstu3.generated.qicoreencounterRelatedConditionAdapter udt = new org.socraticgrid.fhir.dstu3.generated.qicoreencounterRelatedConditionAdapter();
         ...
         List<qicoreencounterRelatedConditionAdapter> param)
   {
      ...
      {
         for (int index = 0; index < ((List<org.socraticgrid.fhir.dstu3.generated.qicoreencounterRelatedConditionAdapter>) param)
               .size(); index++)
         {
